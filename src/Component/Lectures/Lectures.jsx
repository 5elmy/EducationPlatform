...
export default function Lectures() {
  return (
    <div className='grid grid-cols-12 p-5'>
        ...
        <div className='col-span-12 md:col-span-4 lg:col-span-3 p-5'> <Link to={"/lecture"}> <CardLecture title={"Lecture10"} description={"Lorem ipsum dolor sit, amet consectetur adipisicing elit. Ipsa, itaque?"}/></Link></div>
        <div className='col-span-12 md:col-span-4 lg:col-span-3 p-5'> <Link to={"/lecture"}> <CardLecture title={"Lecture11"} description={"Lorem ipsum dolor sit, amet consectetur adipisicing elit. Ipsa, itaque?"}/></Link></div>
        <div className='col-span-12 md:col-span-4 lg:col-span-3 p-5'> <Link to={"/lecture"}> <CardLecture title={"Lecture12"} description={"Lorem ipsum dolor sit, amet consectetur adipisicing elit. Ipsa, itaque?"}/></Link></div>
